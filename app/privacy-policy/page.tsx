    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-5">
        ...
        <p className="px-10">
          ...
          personnelles que vous nous fournissez (y compris, mais sans s'y
          limiter, le nom, le prénom, l'adresse, les informations de paiement,
        ...
        <p className="px-10">
          ...
          via lorisalexandre.dev@gmail.com.
        </p>
